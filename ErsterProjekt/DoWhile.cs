...
//            //while (true)
//            //{
//            //    Console.WriteLine("Bitte Benutzernamen eingeben (mind. 5 Zeichen): ");
//            //    benutzername = Console.ReadLine();

//            //    if (benutzername.Length >= 5)
//            //        break;
//            //    else
//            //        Console.WriteLine("Fehler: Benutzername ist zu kurz!");
//            //}

//            //while (true)
//            //{
//            //    Console.WriteLine("Bitte Passwort eingeben (mind. 10 Zeichen, beginnt mit 'A'): ");
//            //    passwort = Console.ReadLine();

//            //    if (passwort.Length >= 10 && passwort.StartsWith("A"))
//            //        break;
//            //    else
//            //        Console.WriteLine("Fehler: Passwort ungültig!");
//            //}

//            //Console.WriteLine("Konto wurde erfolgreich erstellt!");
