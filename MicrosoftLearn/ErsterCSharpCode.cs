...
//        {
            ...
            // Übung 2: Variablen,Datentypen

            //Console.WriteLine('b');//char(1 Anführungszeichen, 1Zeichen oder Buchstabe)
            //Console.WriteLine(123);//int
            //Console.WriteLine(0.25F);//float(hinten F anhängen)
            //Console.WriteLine(2.625);//double
            //Console.WriteLine(12.39816m);//decimal(hinten m anhängen)
            ...
            //Console.Write("Hello, " + firstName + "! You have " + anzahl + " messages in your inbox. ");
            //Console.WriteLine("The temperature is " + grad + " celsius.");
            ...
            //Console.WriteLine($"Hello, {firstName}! You have {anzahl} messages in your inbox. " +
            //    $"The temperature is {grad} celsius.");
            ...
            //Übung 4 Vorgänge für Zahlen in C# :
            ...
            //Console.WriteLine($"Decimal quotient: {decimalQuotientA}");
            ...
            //Aufgabe MicrosoftLearn if/else/else if
            ...
            //// Separate Rabatt-Anweisung (Regel: eigener IF!)
